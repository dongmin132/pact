...
[![tests](https://img.shields.io/badge/tests-170%2F170-brightgreen)](./test) [![version](https://img.shields.io/badge/version-0.4.1-blue)](./.claude-plugin/plugin.json) [![deps](https://img.shields.io/badge/deps-zero-success)](./package.json) [![license](https://img.shields.io/badge/license-MIT-blue)](#라이선스)
